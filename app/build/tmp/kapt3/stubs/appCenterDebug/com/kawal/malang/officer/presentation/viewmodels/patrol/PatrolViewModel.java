...
public final class PatrolViewModel extends androidx.lifecycle.AndroidViewModel {
    ...
    @org.jetbrains.annotations.NotNull()
    public final kotlinx.coroutines.Job getPatrolHistory() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final kotlinx.coroutines.Job refreshPatrolHistory() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final kotlinx.coroutines.Job doPatrol(@org.jetbrains.annotations.NotNull()
    java.util.ArrayList<java.lang.String> body) {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final kotlinx.coroutines.Job finishPatrol() {
        return null;
    }
