...
public abstract class Hilt_ReportListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ReportListFragment() {
    super();
  }

  Hilt_ReportListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ReportListFragment_GeneratedInjector) this.generatedComponent()).injectReportListFragment(UnsafeCasts.<ReportListFragment>unsafeCast(this));
    }
  }
