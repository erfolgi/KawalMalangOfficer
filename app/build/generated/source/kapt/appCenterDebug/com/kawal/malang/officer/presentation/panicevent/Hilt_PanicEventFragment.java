...
public abstract class Hilt_PanicEventFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PanicEventFragment() {
    super();
  }

  Hilt_PanicEventFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PanicEventFragment_GeneratedInjector) this.generatedComponent()).injectPanicEventFragment(UnsafeCasts.<PanicEventFragment>unsafeCast(this));
    }
  }
