...
public abstract class Hilt_BriefingListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BriefingListFragment() {
    super();
  }

  Hilt_BriefingListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BriefingListFragment_GeneratedInjector) this.generatedComponent()).injectBriefingListFragment(UnsafeCasts.<BriefingListFragment>unsafeCast(this));
    }
  }
