...
import com.kawal.malang.officer.databinding.ItemBantuanSmBinding

class PresisiSmAdapter(private val context: Context, var items: ArrayList<MenuModel>) :
    RecyclerView.Adapter<PresisiSmAdapter.PresisiHolder>() {
    lateinit var mInflater: LayoutInflater


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PresisiHolder {
        mInflater = context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
        val itemRow = mInflater.inflate(R.layout.item_bantuan_sm, parent, false)
    ...
    class PresisiHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private var binding: ItemBantuanSmBinding = ItemBantuanSmBinding.bind(itemView)
