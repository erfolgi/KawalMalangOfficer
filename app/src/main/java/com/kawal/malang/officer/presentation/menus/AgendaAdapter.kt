...
import com.kawal.malang.officer.databinding.ItemAgendaSmBinding
...
class AgendaAdapter (private val context: Context, var items: ArrayList<AgendaItem>)
    : RecyclerView.Adapter<AgendaAdapter.AgendaCardHolder>(){
    ...
    class AgendaCardHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        private var binding: ItemAgendaSmBinding = ItemAgendaSmBinding.bind(itemView)
