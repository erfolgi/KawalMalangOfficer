...
import com.kawal.malang.officer.databinding.ItemGiatBinding
import com.kawal.malang.officer.presentation.giat.detail.DetailGiatActivity

class GiatPageAdapter  (private val context: Context, var items: ArrayList<GiatItem>)
    : RecyclerView.Adapter<GiatPageAdapter.GiatCardHolder>(){
    lateinit var mInflater: LayoutInflater


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GiatCardHolder {
        mInflater = context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
        val itemRow = mInflater.inflate(R.layout.item_giat, parent, false)
    ...
    class GiatCardHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        private var binding: ItemGiatBinding = ItemGiatBinding.bind(itemView)
